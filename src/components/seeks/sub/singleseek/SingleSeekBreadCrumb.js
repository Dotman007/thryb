...
import UsersSubNav from "../../../plans/PlansSubNav";

const SingleSeekBreadCrumb = ({ setSeeksPage, setPage,seekInfo }) => {
...
export default SingleSeekBreadCrumb;
